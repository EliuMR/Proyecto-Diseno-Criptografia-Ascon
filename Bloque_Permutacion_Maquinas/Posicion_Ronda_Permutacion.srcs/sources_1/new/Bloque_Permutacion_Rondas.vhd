...
A5: Permutacion port map(R=>ar_p3,C=>ac_p3,Ronda_A_B=>'0',Contador_Ronda=>"0100",Sr=>ar_p5,Sc=>ac_p4);
A6: Permutacion port map(R=>ar_p4,C=>ac_p4,Ronda_A_B=>'0',Contador_Ronda=>"0101",Sr=>ar_p6,Sc=>ac_p5);
A7: Permutacion port map(R=>ar_p5,C=>ac_p5,Ronda_A_B=>'0',Contador_Ronda=>"0110",Sr=>ar_p1,Sc=>ac_p6);
